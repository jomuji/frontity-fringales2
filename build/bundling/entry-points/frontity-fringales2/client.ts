...
import frontity_share_default from "frontity-share/src/index";
...
if (module["hot"]) {
  module["hot"].accept(
    ...
    () => {
      ...
      const frontity_share_default = require("frontity-share/src/index").default;
      const packages = {
        frontity__mars_theme_default,
        frontity__wp_source_default,
        frontity__tiny_router_default,
